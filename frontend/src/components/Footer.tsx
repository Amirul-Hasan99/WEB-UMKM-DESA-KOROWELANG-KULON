  ...
  return (
    <footer className="mt-20 border-t border-white/60 bg-[#eef2f6] pt-14 pb-8 px-4">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-sm text-gray-600 leading-relaxed">
            {content?.headerSubtitle || 'Portal pemberdayaan UMKM resmi Desa Kutoharjo, Kecamatan Kaliwungu, Kabupaten Kendal.'}
          </p>
        </div>

        {/* Col 2: Navigation Links */}
        <div className="flex flex-col gap-3">
          <h4 className="text-xs font-extrabold uppercase tracking-wider text-red-600">Navigasi Halaman</h4>
          <ul className="flex flex-col gap-2.5 text-sm font-semibold text-gray-600">
            ...
            <li>
              <Link href="/umkm" className="hover:text-red-600 transition-colors">Katalog UMKM Desa</Link>
            </li>
            <li>
              <Link href="/tentang" className="hover:text-red-600 transition-colors">Tentang Program Desa</Link>
            </li>
            <li>
              <Link href="/feedback" className="hover:text-red-600 transition-colors">Kirim Feedback Masyarakat</Link>
            </li>
            <li>
              <Link href="/login" className="hover:text-red-600 transition-colors text-red-700 font-bold">Portal Login Staff Admin</Link>
            </li>
          </ul>
        </div>
        ...
        {/* Col 3: Contact Info */}
        <div className="flex flex-col gap-3">
          <h4 className="text-xs font-extrabold uppercase tracking-wider text-red-600">Kontak Balai Desa</h4>
          <div className="flex flex-col gap-2.5 text-sm text-gray-600">
            <div className="flex items-start gap-2.5">
              <MapPin className="w-4 h-4 text-red-600 shrink-0 mt-1" />
              <span>{content?.villageAddress || 'Jl. Raya Kutoharjo No. 01, Kec. Kaliwungu, Kab. Kendal'}</span>
            </div>
            ...
            <div className="flex items-center gap-2.5">
              ...
              <span>{content?.contactEmail || 'info@kutoharjo.desa.id'}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-gray-300/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-gray-500">
        <p>{content?.footerText || '© 2026 Pemerintah Desa Kutoharjo.'}</p>
        <p className="flex items-center gap-1">
          Diberdayakan oleh <span className="font-bold text-gray-700">Warga Kutoharjo</span>
